...
export default {
  ...
  methods: {
    ...
    cellClassName({ row, column, rowIndex, columnIndex }) {
      if (column.property === 'categoryTitle' || column.property === 'contractNum' || column.property === 'customerName' || column.property === 'intoContractId' || column.property === 'intoContractName') {
    ...
    handleRowClick(row, column, event) {
      if (column.property == 'contractNum') {
        ...
        this.relatedID = row.contractId
        this.relatedCRMType = 'contract'
        this.showDview = false
      } else if (column.property == 'intoContractId') {
        this.showRelatedDetail = true
        this.relatedID = row.intoContractId
        this.relatedCRMType = 'contract'
        this.showDview = false
        ...
        this.showRelatedDetail = true
        this.relatedID = row.customerId
        this.relatedCRMType = 'customer'
        this.showDview = false
      } else if (column.property == 'intoContractName') {
        this.showRelatedDetail = true
        this.relatedID = row.intoContractId
        this.relatedCRMType = 'contract'
        this.showDview = false
