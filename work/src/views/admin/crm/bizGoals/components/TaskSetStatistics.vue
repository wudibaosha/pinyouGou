<template>
  <div
    ...
    <flexbox class="handle-bar" justify="space-between">
      ...
      <div
        v-if="!isEdit || list.length === 0"
        style="flex-shrink: 0;">
        <el-button
          @click="addViewShow = true">设置目标</el-button>
        ...
        <el-button
          type="primary"
          @click.native="handleClick('import')">导入</el-button>
        <el-button
          v-if="list.length"
          type="primary"
          @click="handleClick('export')">导出</el-button>
      </div>
