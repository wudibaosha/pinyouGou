...
export default {
  ...
  methods: {
    ...
    dragLeftEnd(evt) {
      ...
      newField.operating = this.moduleType === 'crm_marketing' ? 253 : 255
      newField.formAssistId = this.generateFormAssistId(ids) // 辅助id
      ...
      switch (this.movedField.formType) {
        ...
        case 'serial_number':
          ...
          break
        case 'field_tag':
          newField.operating = 249
          break
        case 'field_attention':
          newField.operating = 250
          newField.defaultValue = null
          break
        case 'field_group':
          newField.operating = 224
          break
      }
    ...
    handleActionCopy(point) {
      ...
      copyField.operating = this.moduleType === 'crm_marketing' ? 253 : 255
