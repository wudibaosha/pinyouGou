...
export default {
  ...
  methods: {
    ...
    getDetail() {
      ...
      this.path = `${WKConfig.getLocationOrigin()}/${process.env.VUE_APP_MARKETING_FOLDER}/#/?marketingId=${this.detail.enMarketingId}&currentUserId=${this.detail.currentUserId}`
      this.loading = false
