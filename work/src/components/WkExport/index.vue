...
export default {
  ...
  methods: {
    ...
    getFieldList() {
      ...
      const request = this.crmProps.isSeas ? filedGetPoolTableFieldAPI : filedGetTableFieldAPI
      request(params)
        .then(res => {
          //非合同
          if(params.label != 6){
          ...
          for (let index = 0; index < res.data.length; index++) {
            ...
            selectionList.push(element.id)
          }
          console.log(fieldList, selectionList)
