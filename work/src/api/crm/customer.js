...
export function transferCustomerRelativeDataAPI(data) {
  return request({
    url: 'crmCustomer/transferCustomerRelativeData',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
 ...
 * @param {*} data
 */
export function crmCustomerSameNameAPI(data) {
  return request({
    url: 'crmCustomer/getSameCustomer/'+data,
    method: 'post',
  })
}
 ...
 * id 客户IDs
 */
export function crmContractReturnOrPostAPI(data) {
  return request({
    url: 'crmContract/changeContractReturnOrPost',
    method: 'post',
    data: data
  })
}
