 ...
 * @param {*} data
 */
export function crmQueryDishonorReasonAPI(data) {
  return request({
    url: 'crmInvoice/queryDishonorReason',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
 ...
 * @param {*} data
 */
export function crmSetDishonorReasonAPI(data) {
  return request({
    url: 'adminConfig/setDishonorReason',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
